...
let summary = "Small DSL to create an interactive cli"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Small DSL to create an interactive cli"

// List of author names (for NuGet package)
let authors = [ "Wirtz N." ]

// Tags for your project (for NuGet package)
let tags = "FsMenu F# CLI cli"

// File system information 
let solutionFile  = "FsMenu.sln"
...
let gitRaw = environVarOrDefault "gitRaw" "https://raw.github.com/nicolaiw"
...
Target "Release" DoNothing// (fun _ ->
//    StageAll ""
